...
<body class="bg-gray-50">
    ...
    <nav class="bg-blue-800 text-white shadow-lg">
                ...
                <div class="hidden md:flex">
                    <div class="flex space-x-1">
                        ...
                        <div class="dropdown relative">
                            ...
                            <div class="dropdown-menu absolute bg-white text-gray-800 rounded shadow-lg mt-1 w-48 z-10">
                                <a href="#" class="block px-4 py-2 hover:bg-gray-100">Nova Factura</a>
                                <a href="#" class="block px-4 py-2 hover:bg-gray-100">Factures Pendents</a>
                                <a href="#" class="block px-4 py-2 hover:bg-gray-100">Històric</a>
                            </div>
                        </div>
        ...
        <div id="mobile-menu" class="mobile-menu md:hidden bg-blue-700 px-4 pb-3">
            <!-- Dropdown 1: Clients -->
            <div class="mb-2">
                <button class="mobile-dropdown-btn w-full text-left px-3 py-2 rounded flex justify-between items-center bg-blue-600">
                ...
                <div class="mobile-dropdown-content pl-4 mt-1">
                    ...
                    <a href="categoria_productes.php" class="block px-3 py-2 rounded hover:bg-blue-600">categoria productes</a>
                </div>
            </div>
            ...
            <div class="mb-2">
                ...
                <div class="mobile-dropdown-content pl-4 mt-1">
                    <a href="#" class="block px-3 py-2 rounded hover:bg-blue-600">Nova Factura</a>
